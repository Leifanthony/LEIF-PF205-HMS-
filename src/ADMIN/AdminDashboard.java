...
public class AdminDashboard extends javax.swing.JFrame {
    ...
    private void applyModernDesign() {
        ...
        mainPanel.setBounds(0, 0, 740, 490);
        
        // Add header
        HeaderPanel headerPanel = new HeaderPanel();
        headerPanel.setBounds(0, 0, 780, 70);
        mainPanel.add(headerPanel);
        
        // Add close button
        CloseButton closeBtn = new CloseButton();
        closeBtn.setBounds(730, 15, 40, 30);
        ...
        // Add menu items with proper spacing (matching UserDash1)
        int startY = 20;
        int spacing = 65;
        
        MenuPanel homePanel = new MenuPanel("HOME", new Color(51, 51, 51), () -> {
            showCustomDialog("Welcome to Admin Dashboard", "HOME");
        });
        homePanel.setBounds(20, startY, 240, 60);
        leftPanel.add(homePanel);
        
        MenuPanel usersPanel = new MenuPanel("USERS", MEDIUM_PURPLE, () -> {
            CustomerPage cp = new CustomerPage();
            cp.setVisible(true);
            cp.setLocationRelativeTo(null);
        });
        usersPanel.setBounds(20, startY + spacing, 240, 60);
        leftPanel.add(usersPanel);
        
        MenuPanel roomsPanel = new MenuPanel("MANAGE ROOM", DARK_PURPLE, () -> {
            dispose();
            new ManageRoom().setVisible(true);
        });
        roomsPanel.setBounds(20, startY + (spacing * 2), 240, 60);
        leftPanel.add(roomsPanel);
        
        MenuPanel billsPanel = new MenuPanel("CUSTOMER BILLS", new Color(88, 41, 88), () -> {
            dispose();
            new CustomerDetailBills().setVisible(true);
        });
        billsPanel.setBounds(20, startY + (spacing * 3), 240, 60);
        leftPanel.add(billsPanel);
        ...
        logoutPanel.setBounds(20, startY + (spacing * 4), 240, 60);
        leftPanel.add(logoutPanel);
        
        // Add decorative elements to left panel (matching UserDash1)
        ...
        // Create right panel for image - matching UserDash1 design exactly
        ...
        // Try to load and display the image - matching UserDash1 exactly
        try {
            ImageIcon originalIcon = new ImageIcon(getClass().getResource("/images/admin.PNG"));
        ...
        // Add admin info overlay - matching UserDash1 design
        ...
        userLabel.setFont(new Font("Constantia", Font.BOLD, 11));
        userLabel.setForeground(new Color(255, 215, 0, 200));
        userLabel.setBounds(10, 8, 290, 15);
        infoPanel.add(userLabel);
        
        JLabel emailLabel = new JLabel("Administrator Access");
        emailLabel.setFont(new Font("Constantia", Font.BOLD, 14));
        emailLabel.setForeground(Color.WHITE);
        emailLabel.setBounds(10, 28, 290, 20);
        ...
        SwingUtilities.invokeLater(() -> {
            showCustomDialog("Welcome to Admin Dashboard", "WELCOME");
        });
    ...
    private void initComponents() {
        ...
        jPanel3.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 320, 70));
        ...
        jPanel3.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 320, 60));
        ...
        jPanel3.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 410, 320, 60));
        ...
        jLabel3.setText("CUSTOMER BILLS");
        ...
        jPanel3.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 320, 60));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 380, 490));
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 380, 470));
